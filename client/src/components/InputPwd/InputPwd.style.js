...
export const Input_Container = styled.div`
  ...
  flex-direction: ${(props) =>
    props.focus || props.inputPw ? "column" : "low"};
  border: ${(props) =>
      props.focus || props.inputPw ? "2px #1D9BF0" : "1px #D1D9DD"}
    solid;
`;
